            ...
            function(updateError, oldVersion) {
                ...
                if(updateError) {
                    ...
                    if (oldVersion.value == null) {
                        ...
                        responseToSend = CONSTANTS.EMAIL_ACTIVATION_SUCCESS_HTML_BODY.replace(/EMAIL_REFERRAL_URL/g, EMAIL_REFERRAL_URL.replace('EMAILACTIVATIONREFERRALPLACEHOLDER', getReferralToken(email)));
                    }
                }
