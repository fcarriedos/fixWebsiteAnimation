...
webapp.post('/api/lead/bot', 
	...
	check('first_name').exists().custom((value) => value.length > 0).withMessage('The name is empty'),
	check('last_name').exists().custom((value) => value.length > 0).withMessage('The name is empty')
